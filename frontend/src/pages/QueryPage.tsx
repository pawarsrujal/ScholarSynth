...
export const QueryPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:bg-gradient-to-br dark:from-slate-900 dark:via-slate-900 dark:to-slate-800">
      {/* Header */}
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">ScholarSynth</h1>
                <p className="text-sm text-gray-600 dark:text-gray-300">AI-Powered Deep Research System</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <DarkModeToggle />
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="space-y-8">
          ...
          {!currentTaskId && (
            <div className="card max-w-3xl mx-auto">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                <p className="text-sm font-semibold text-gray-700 dark:text-gray-200 mb-3">Example queries:</p>
          ...
          {/* Error Display */}
          {isFailed && (
            <div className="card bg-red-50 border-red-200 dark:bg-red-900 dark:border-red-700">
              <div className="flex items-start gap-3">
                <AlertCircle className="w-6 h-6 text-red-600 mt-1" />
                <div>
                  <h3 className="font-semibold text-red-900 dark:text-red-200">Research Failed</h3>
                  <p className="text-red-700 dark:text-red-300 mt-1">{report?.error || 'An unknown error occurred'}</p>
                  <button
                    onClick={handleReset}
          ...
          {isDone && report?.report && (
            <div className="space-y-4">
              <div className="card bg-green-50 border-green-200 dark:bg-green-900 dark:border-green-700">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <Sparkles className="w-6 h-6 text-green-600" />
                    <div>
                      <h3 className="font-semibold text-green-900 dark:text-green-200">Research Complete!</h3>
      ...
      {/* Footer */}
      <footer className="mt-16 py-6 border-t border-gray-200 bg-white dark:bg-gray-900 dark:border-gray-700">
